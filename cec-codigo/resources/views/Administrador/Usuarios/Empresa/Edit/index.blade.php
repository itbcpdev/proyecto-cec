...
@section('titulo')
    Usuario Empresa Editar | Intranet CEC
@endsection
@endsection
...
@section('content')
@include('Administrador.Usuarios.Empresa.Edit.content')
@endsection
...
<script>
    ...
    @if( $usuario ) {
        let arraySectores =  @json($sectores_secundarios);
        data = arraySectores;
    }
    @endif
    jQuery('#gruposectores').val(data);
