    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="h2 mb-3">Editar Campaña</h4>
                <form action="{{ route('admin.campaign.update', ['id' => $campaign->id]) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" value="{{ $campaign->nombre }}"
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('assets/campaign/image/' . $campaign->banner) }}" class="d-block"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="descripcion" id="descripcion" rows="4">{{ $campaign->descripcion }}</textarea>
                                @error('descripcion')
                                    <span class="invalid-feedback d-block mt-2" role="alert">
                                        <strong>{!! $message !!}</strong>
                                    </span>
                    ...
                    <a href="{{ route('admin.campaign.index') }}" class="btn btn-danger">Volver</a>
                </form>
            </div>
        </div>
    </div>
