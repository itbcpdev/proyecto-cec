                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" name="nombre" id="nombre" placeholder="Nombre" value="{{ $empresa->nombre }}">
                                @error('nombre')
                            ...
                            <div class="form-group">
                                ...
                                <input id="fec_inscrip_cec"  width="276" value="{{ $empresa->fec_inscrip_cec }}" name="fec_inscrip_cec" />
                            ...
                            <div class="form-group">
                                ...
                                <input id="fec_aniversario_empresa"  width="276" value="{{ $empresa->fec_aniversario_empresa }}"  name="fec_aniversario_empresa" />
