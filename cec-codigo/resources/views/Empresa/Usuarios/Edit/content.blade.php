    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('empresa.usuarios.update', ['id' => $usuario->id]) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre" value="{{ $usuario->name }}">
                                @error('nombre')
                                ...
                                <div>
                                    <select class="form-select" name="perfil_id">
                                        @foreach ($perfiles as $perfil)
                                            ...
                                            {{ $perfil['id'] == $usuario->perfil_id ? 'selected' : '' }}>{{ $perfil['nombre'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
