    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('empresa.usuarios.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="celular_contacto" id="celular_contacto" value="{{ old('celular_contacto') }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="numero_fijo" id="numero_fijo" value="{{ old('numero_fijo') }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lugar_residencia" id="lugar_residencia" value="{{ old('lugar_residencia') }}">
                    ...
                    <a href="{{ route('empresa.usuarios.index') }}" class="btn btn-danger">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
