<div class="content-wrapper">
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <a href="{{ route('empresa.usuarios.create') }}" class="btn btn-block btn-lg btn-success"><span class="mdi mdi-plus"></span> Crear
                Usuario</a>
        </nav>
    </div>
    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-success"
                                            href="{{ route('empresa.usuarios.edit', ['id' => $usuario->id]) }}">
                                            <span class="">
                                        ...
                                        <a class="btn btn-sm btn-danger"
                                            href="{{ route('empresa.usuarios.delete', ['id' => $usuario->id]) }}">
                                            <span class="">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
